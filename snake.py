...
class SNAKE:
        ...
        def move(self):
                ...
                if new[0] in range(0,screen_width) and new[1] in range(0,screen_width) and not new in self.positions[2:]:
...
class FOOD:
        ...
        def random_position(self):
                self.position = (random.randint(0,grid_width-1)*gridsize,random.randint(0,gridsize-1)*gridsize)
        def draw(self, surface):
